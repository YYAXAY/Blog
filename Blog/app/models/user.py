...
from werkzeug.security import generate_password_hash, check_password_hash   # 密码散列及校验
...
class User(UserMixin, db.Model):
    ...
    password_hash = db.Column(db.String(128))       # 保存加密后的密码
    ...
    # 激活账户时的token校验,校验时不知道用户是谁，因此定义为静态方法,通过类名调用
    @staticmethod
